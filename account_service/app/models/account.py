...
class DBAccount(Base):
    ...
    #     if balance < DBAccount.minimum_balance:
    #         raise ValueError("Minimum balance is ${DBAccount.minimum_balance}")
    #     self._balance = balance


class DBSavingsAccount(DBAccount):
    """
...
class DBCurrentAccount(DBAccount):
    """
